    ...
    return (
        <MfaDialog
            ...
            <Typography gutterBottom>
                For this operation you have to scan this QR code in an OTP application on your phone and enter the digits in the input box located between this text and the QR code (or RTFM)
            </Typography>
        </MfaDialog>
    );
};
